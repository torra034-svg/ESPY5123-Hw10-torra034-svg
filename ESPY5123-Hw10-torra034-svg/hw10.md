...
- [Dataset](#dataset)
  ...
  - [The dataset has 4454 rows and 14 columns. Most of the variables are
    ...
    job are categorical predictors. The outcome is cateogorical (e.g
    good / bad). Variables that are useful for prediction include job,
...
![](hw10_files/figure-gfm/outcome-exploration-2.png)<!-- -->
